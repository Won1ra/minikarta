...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<div id="Ñïðÿòàòü" style="position: absolute; right: 1em; bottom: 1em;">' +
        ...
        '<div id="minimap-box" style="position: relative;width:220px;height:200px">' +
        '<canvas id="minimap" style="width: 100%; height: 100%;z-index:1;position:absolute;top:1;left:0;"></canvas>' +
        ...
        '<span id="hide-map" style="cursor:pointer;"> Ñêðûòü' +
        '</span> | <span id="follow-mouse" style="cursor:pointer;"Seguir o mouse' +
        '</span> | Ìàñøòàá: <span id="zoom-plus" style="cursor:pointer;font-weight:bold;">+</span>  /  ' +
    ...
    document.getElementById("hide-map").onclick = function () {
        ...
        document.getElementById("minimap-text").innerHTML = "Ïîêàçàòü";
...
function loadTemplates() {
    ...
    if (needed_templates.length == 0) {
        if (zooming_in == false && zooming_out == false) {
            document.getElementById("minimap-box").style.display = "none";
            document.getElementById("minimap-text").style.display = "block";
            document.getElementById("minimap-text").innerHTML = "Òóò íè÷åãî íåò.";
        }
    } else {
        document.getElementById("minimap-box").style.display = "block";
        document.getElementById("minimap-text").style.display = "none";
...
function getCenter() {
    ...
    x_window = url.replace(re, '$1');
    y_window = url.replace(re, '$2');
